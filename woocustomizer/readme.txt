...
**[See Video Overview](https://storecustomizer.com/go/catalogue-mode/)**
...
**[See Video Overview](https://storecustomizer.com/go/product-quick-view/)**
...
**[See Video Overview](https://storecustomizer.com/go/ajax-search/)**
...
**[See Video Overview](https://storecustomizer.com/go/menu-cart/)**
...
**[See Video Overview](https://storecustomizer.com/go/custom-thank-you-pages/)**
...
**[See Video Overview](https://storecustomizer.com/go/handheld-footer-bar/)**
...
**[See Video Overview](https://storecustomizer.com/go/product-badges/)**
...
We're always needing new translations, so please [contact us here](https://storecustomizer.com/go/contact-us/) if you are willing to help translate StoreCustomizer into a language that we don't have yet.
...
StoreCustomizer requires the [WooCommerce](https://wordpress.org/plugins/woocommerce/) plugin to be installed and active.
...
1. **StoreCustomizer Settings Page** - Placed neatly in the Dashboard under WooCommerce -> StoreCustomizer.
2. **StoreCustomizer Free Settings** - Edit all WooCommerce pages + many more useful features.
3. **StoreCustomizer Settings** - Add extra useful features to your WooCommerce store pages.
4. **WooCommerce Shop Page Settings** - Edit many settings on the WooCommerce Shop and Archive Product Pages.
5. **WooCommerce Product Page Settings** - Edit many settings on your WooCommerce Product Signle Pages.
6. **WooCommerce User Account Page** - Edit user account page design & tab text or headings for each Account page.
7. **WooCommerce Cart Page** - Edit your WooCommerce store Cart page & add extra useful functionality.
8. **WooCommerce Checkout Page** - Edit your WooCommerce store Checkout page & add extra useful functionality.


== Frequently Asked Questions ==

= Will StoreCustomizer work with my theme?
It should ! But as themes can add their own CSS or templates which might affect StoreCustomizer from working perfectly... We're here to help... [Let us know](https://storecustomizer.com/go/contact-us/) if something doesn't work and we'll help you fix it.
...
Please [contact us](https://storecustomizer.com/go/contact-us/) if something does not work on your site so that we can try and help.

= I found a bug... What do I do?
Please [contact us](https://storecustomizer.com/go/contact-us/) so we can post a fix and get it working for you.
...
= 2.2.2 =
* Styling tweaks/fixes
* Updates plugin tags for wp.org
...
= 1.1.9 =
* Styling tweaks/fixes
* Added FAQ's to the WordPress.org page
