						...
						<label for="variation_<?php echo $variation_id; ?>" class="wl-pl-checkbox-label">
							<div class="wl-pl-item-name">
								...
								<?php if ( 'yes' == $settings['variation_desc_show_hide'] && $description != '' ):?>
									<span class="wl-pl-item-desc"><span class="wl-pl-item-desc-text"><?php echo wp_trim_words( $description, sanitize_number( $settings['product_desc_words_count'] ) ); ?></span></span>
								<?php endif; ?>
							</div>
