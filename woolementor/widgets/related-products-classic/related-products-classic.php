						...
						<div class="wl-rpc-single-widget">
							...
							<div class="wl-rpc-product-details">
								<div class="wl-rpc-product-info">
                                    ...
                                    <h2 class="wl-rpc-price"><?php echo $product->get_price_html(); ?></h2>
								</div>
								<div class="wl-rpc-info-icons">
									<?php if ( 'yes' == $wishlist_show_hide ): ?>
										<div class="wl-rpc-product-fav ajax_add_to_wish <?php echo esc_attr( $fav_item ); ?>" data-product_id="<?php echo $product_id; ?>">
                                    ...
                                    if ( 'yes' == $cart_show_hide ):
                                        ...
                                        if ( 'simple' == $product->get_type() ): ?>
                                            <div class="wl-cart-area">
                                                <a href="?add-to-cart=<?php echo $product_id; ?>" data-quantity="1" class="wl-rpc-product-cart button product_type_<?php echo esc_attr( $product->get_type() ); ?> add_to_cart_button ajax_add_to_cart" data-product_id="<?php echo $product_id; ?>" ><i class="<?php echo esc_attr( $cart_icon['value'] ); ?>"></i></a>
                                            </div>
                                        <?php else: ?>
                                            <div class="wl-cart-area">
                                                <a href="<?php echo get_permalink( $product_id ); ?>" data-quantity="1" class="wl-rpc-product-cart button product_type_<?php echo esc_attr( $product->get_type() ); ?>" data-product_id="<?php echo $product_id; ?>" ><i class="<?php echo esc_attr( $cart_icon['value'] ); ?>"></i></a>
                                            </div>
                                        <?php endif;
                                    endif ?>
								</div>
