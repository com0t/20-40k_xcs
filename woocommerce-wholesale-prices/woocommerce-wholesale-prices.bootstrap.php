...
if (WWP_Helper_Functions::is_plugin_active('woocommerce/woocommerce.php')) {
    ...
    if (WWP_Helper_Functions::is_plugin_active('woocommerce-wholesale-prices-premium/woocommerce-wholesale-prices-premium.bootstrap.php')) {
        ...
        if (version_compare($wwpp_plugin_data['Version'], '1.27', '<')) {
            ...
            function wwp_missing_plugin_dependency_notice()
            {
                ...
                <div class="error">
                    ...
                    <p><?php echo sprintf(__('We have detected an outdated version of WooCommerce Wholesale Prices Premium. You require at least version %1$s for this version of WooCommerce Wholesale Prices ( %2$s ). Please update now.', 'woocommerce-wholesale-prices'), $min_wwpp_version, $min_wwp_version); ?></p>
                </div>
