...
require_once 'includes/admin-custom-fields/prices/class-wwp-wholesale-price-non-wholesale.php';
...
class WooCommerceWholeSalePrices
{
    ...
    public function __construct()
    {
        ...
        $this->wwp_non_wholesale              = WWP_Wholesale_Prices_Non_Wholesales::instance(array('WWP_Wholesale_Roles' => $this->wwp_wholesale_roles));
