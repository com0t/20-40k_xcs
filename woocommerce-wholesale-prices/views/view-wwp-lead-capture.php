...
<div id="wwp-wholesale-lead-capture-page" class="wwp-page wrap nosubsub">
  ...
  <div id="step-1" class="row-container step-container">
    ...
    <div class="two-column">
      ...
      <p><a class="button-green" href="https://wholesalesuiteplugin.com/woocommerce-wholesale-lead-capture/?utm_source=freeplugin&utm_medium=upsell&utm_campaign=wwlcpage" target="_blank"><?php _e('Get Wholesale Lead Capture', 'woocommerce-wholesale-prices'); ?></a></p>
    </div>
  </div>
