...
<tr>
    <td>
        <div class="free-vs-premium box">
            ...
            <h1><?php _e('Free vs Premium', 'woocommerce-wholesale-prices');?></h1>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3">
                            <h1><?php _e('+100\'s of other premium wholesale features', 'woocommerce-wholesale-prices');?></h1>
                            <a href="https://wholesalesuiteplugin.com/woocommerce-wholesale-prices-premium/?utm_source=freeplugin&utm_medium=upsell&utm_campaign=upgradepagewwppbutton" target="_blank" class="full-features">
        ...
        <div class="wholesale-suite-bundle box">
            <h1><?php _e('Wholesale Suite Bundle', 'woocommerce-wholesale-prices');?></h1>
            ...
            <br/><br/>
            <div class="products">
                <h2><?php _e('WooCommerce Wholesale Prices Premium', 'woocommerce-wholesale-prices');?></h2>
                <div class="row">
                    <div class="column">
                        ...
                        <p><a href="https://wholesalesuiteplugin.com/woocommerce-wholesale-prices-premium/?utm_source=freeplugin&utm_medium=upsell&utm_campaign=upgradepagewwpplearnmore" target="_blank"><?php _e('Learn more about Prices Premium', 'woocommerce-wholesale-prices');?></a></p>
                    </div>
                    <div class="column">
            ...
            <div class="products">
                <h2><?php _e('WooCommerce Wholesale Order Form', 'woocommerce-wholesale-prices');?></h2>
                <div class="row">
                    <div class="column">
                        ...
                        <p><a href="https://wholesalesuiteplugin.com/woocommerce-wholesale-order-form/?utm_source=freeplugin&utm_medium=upsell&utm_campaign=upgradepagewwoflearnmore" target="_blank"><?php _e('Learn more about Order Form', 'woocommerce-wholesale-prices');?></a></p>
                    </div>
                    <div class="column">
            ...
            <div class="products">
                <h2><?php _e('WooCommerce Wholesale Lead Capture', 'woocommerce-wholesale-prices');?></h2>
                <div class="row">
                    <div class="column">
                        ...
                        <p><a href="https://wholesalesuiteplugin.com/woocommerce-wholesale-lead-capture/?utm_source=freeplugin&utm_medium=upsell&utm_campaign=upgradepagewwlclearnmore" target="_blank"><?php _e('Learn more about Lead Capture', 'woocommerce-wholesale-prices');?></a></p>
                    </div>
                    <div class="column">
            ...
            <div class="products">
                <h1><?php _e('The WooCommerce extensions to grow your wholesale business', 'woocommerce-wholesale-prices');?></h1>
                <a href="https://wholesalesuiteplugin.com/bundle/?utm_source=freeplugin&utm_medium=upsell&utm_campaign=upgradepagebundlebutton" target="_blank" class="see-bundle">
