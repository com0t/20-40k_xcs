...
<div id="wwp-wholesale-order-form-page" class="wwp-page wrap nosubsub">
  ...
  <div class="row-container">
    <div class="one-column">
      ...
      <div class="page-title"><?php _e('Quicker ordering for your customers', 'woocommerce-wholesale-prices'); ?></div>

      <p class="page-description"><?php _e('Wholesale Order Form gives you a customizable wholesale-specific registration form,<br />
  ...
  <div id="step-1" class="row-container step-container">
    <div class="two-column">
    ...
    <div class="two-column">
      ...
      <p><a class="button-green" href="https://wholesalesuiteplugin.com/woocommerce-wholesale-order-form/?utm_source=freeplugin&utm_medium=upsell&utm_campaign=wwofpage" target="_blank"><?php _e('Get Wholesale Order Form', 'woocommerce-wholesale-prices'); ?></a></p>
    </div>
  </div>

  <div id="step-2" class="row-container step-container">
    <div class="two-column">
    ...
    <div class="two-column">
      ...
      <p><a class="button-grey" href="#"><?php _e('Start Setup', 'woocommerce-wholesale-prices'); ?></a></p>
    </div>
  </div>
</div>