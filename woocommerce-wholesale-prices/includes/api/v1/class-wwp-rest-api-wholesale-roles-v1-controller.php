...
if (!class_exists('WWP_REST_Wholesale_Roles_V1_Controller')) {
    ...
    class WWP_REST_Wholesale_Roles_V1_Controller extends WC_REST_Controller
    {
        ...
        public function permissions_check($request)
        {
            ...
            return new WP_Error('wholesale_rest_role_permission_failed', __("You don't have permission.", 'woocommerce-wholesale-order-form'), array('status' => rest_authorization_required_code()));
