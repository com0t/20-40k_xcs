        ...
        public function sub_fields($current_section = '')
        {
            ...
            if ($current_section == 'wwpp_setting_price_section') {
                ...
                $wwp_non_wholesale_settings = array(
                    ...
                    array(
                        'type' => 'multiselect',
                        'id' => 'wwp_wholesale_role_select_chosen',
                    ),
        ...
        private function _get_general_section_settings()
        {
            $general_settings = array(
                ...
                array(
                    ...
                    'desc_tip' => __('Complete documentation on usage tracking is available <a href="https://wholesalesuiteplugin.com/kb/usage-tracking/?utm_campaign=freeplugin&utm_medium=kb&utm_campaign=helppageusagetracking" target="_blank">here</a>.', 'woocommerce-wholesale-prices'),
                ...
                array(
                    ...
                    'desc' => sprintf(
                        ...
                        'https://wholesalesuiteplugin.com/bundle/?utm_source=freeplugin&utm_medium=upsell&utm_campaign=generalsettingsboxlink'
                    ),
...
<tr>
    <td style="padding: 0px; display: flex; padding-top: 20px;">
        ...
        <a class="wws-bundle-btn" target="_blank"
            href="https://wholesalesuiteplugin.com/bundle/?utm_source=freeplugin&utm_medium=upsell&utm_campaign=wwptaxbundlebutton">
            <div>
        ...
        <a class="wwpp-addon" target="_blank"
            href="https://wholesalesuiteplugin.com/woocommerce-wholesale-prices-premium/?utm_source=freeplugin&utm_medium=upsell&utm_campaign=wwptaxwwppbutton"><?php _e('Wholeasale Prices Premium Add-on &rarr;', 'woocommerce-wholesale-prices');?></a>
    </td>
</tr>
<?php }
