...
class WWP_Lead_Capture
{
  ...
  public function register_lead_capture_page_menu()
  {
    ...
    if (
      ...
      add_submenu_page(
        'woocommerce',
        __('Wholesale Lead Capture', 'woocommerce-wholesale-prices'),
        __('Wholesale Leads', 'woocommerce-wholesale-prices'),
    ...
    if (function_exists('wc_admin_connect_page')) {
      wc_admin_connect_page(
        array(
          ...
          'screen_id' => 'woocommerce_page_wwp-lead-capture-page',
  ...
  public function run()
  {
    ...
    add_action('admin_menu', array($this, 'register_lead_capture_page_menu'), 10);
