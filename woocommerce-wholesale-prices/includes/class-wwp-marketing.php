    ...
    class WWP_Marketing
    {
        ...
        public function filter_wc_marketing_recommended_plugins($recommended_plugins)
        {
            ...
            if (
                ...
                $wws_check = !empty($recommended_plugins) ? array_filter($recommended_plugins, function ($plugin) {
            ...
            if (!WWP_Helper_Functions::is_acfwf_installed()) {
                ...
                $acfw_check = !empty($recommended_plugins) ? array_filter($recommended_plugins, function ($plugin) {
