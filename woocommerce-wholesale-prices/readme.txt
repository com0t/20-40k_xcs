...
Donate link:
Tags: woocommerce wholesale, wholesale plugin, wholesale prices, wholesale pricing, b2b
...
**🏆 #1 WooCommerce wholesale plugin for adding wholesale prices & managing B2B customers.** Trusted by 20k+ store owners with 350+ 5-star reviews.
...
1. Change the customer's user role to "Wholesale Customer" and they'll see the pricing
...
* Set wholesale prices (different prices per product) on Simple product or Variable product variations
...
* Adjust the wholesale role & wholesale price text
...
* 🚀 Get started quickly with the [getting started guide!](https://wholesalesuiteplugin.com/kb/woocommerce-wholesale-prices-free-plugin-getting-started-guide/)

***Wholesale Suite can handle complex wholesale businesses – see our full range of wholesale WooCommerce extensions:***

Learn more about Wholesale Suite: [Wholesale Suite for WooCommerce](https://wholesalesuiteplugin.com)
...
1. [WooCommerce Wholesale Order Form](https://wholesalesuiteplugin.com/woocommerce-wholesale-order-form/) – Wholesale order form plugin for showing your whole catalog on one page, fully AJAX driven with no reloading, fast add to cart, searchable & filterable.
1. [WooCommerce Wholesale Lead Capture](https://wholesalesuiteplugin.com/woocommerce-wholesale-lead-capture/) - Wholesale registration form, advanced user approvals system, wholesale login, email templates, and more.
...
**FREE, SIMPLE & ACCURATE – WHOLESALE WOOCOMMERCE PRICING EXTENSION**
...
Providing WooCommerce bulk discounts has never been easier for wholesale WooCommerce customer types.

Wholesale Suite lets you add new wholesale WooCommerce user roles to create a role hierarchy for your customers. This allows you to show multiple prices per product based on the user role.
...
In your Product Edit screen you'll find a new wholesale pricing box. This lets you enter wholesale prices for the Wholesale Customer user role, effectively giving them wholesale discounts based on their user role for the product.
...
**WOOCOMMERCE DYNAMIC PRICING WITH FLEXIBILITY**
...
You can add multiple wholesale user roles with the [WooCommerce Wholesale Prices Premium add-on](https://wholesalesuiteplugin.com/woocommerce-wholesale-prices-premium/).

You can also add a custom WooCommerce user registration for your wholesale customers with our [Wholesale Lead Capture plugin](https://wholesalesuiteplugin.com/woocommerce-wholesale-lead-capture/).
...
Click here to ditch the spreadsheets & learn what [Wholesale Suite](https://wholesalesuiteplugin.com/bundle/) can do for your business.
...
1. Change the customer's user role by going to Users->All Users, clicking edit on the user, and changing their ***User Role*** to the Wholesale Customer role.
1. See the [getting started guide](https://wholesalesuiteplugin.com/kb/woocommerce-wholesale-prices-free-plugin-getting-started-guide/) for this plugin.

== Frequently asked questions ==

We have hundreds of guides and frequently asked questions answered in our online [knowledge base](https://wholesalesuiteplugin.com/knowledge-base/).

See the [getting started guide](https://wholesalesuiteplugin.com/kb/woocommerce-wholesale-prices-free-plugin-getting-started-guide/) for this plugin.

For more details about features please [see the product page here](https://wholesalesuiteplugin.com/woocommerce-wholesale-prices-premium/).
...
* Bug Fix: API: When getting a wholesale product or variation with return_wholesale_products set to true it will say it's not a wholesale product
